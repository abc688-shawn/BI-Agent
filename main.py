...
qwen_tokenizer = AutoTokenizer.from_pretrained("/data01/lanjunfei/code/output/agent/Qwen3_14B/swift_image/1124/2_dense_agent_v24_liantiao_think/hf_output")
...
if __name__ == "__main__":
    ...
    if test_dataframe is not None and main_prompt_template is not None and eval_prompt_template is not None:
        ...
        for index, row in test_dataframe.iterrows():
            ...
            if greedy_outputs:
                ...
                if evaluation_outputs_greedy:
                    ...
                    try:
                        ...
                        if result_correct == 1 or other_true_count >= 3: 
            ...
            if sample_outputs:
                ...
                for i, sample_output in enumerate(sample_outputs):
                    ...
                    evaluation_outputs_sample = eval_client.call_llm(
                        eval_prompt_sample,
                        n=1,
                        temperature=0.0,  # 评估建议用确定性输出
                        top_p=1.0
        ...
        if results:
            ...
            df_results.to_csv('./data/evaluation_results.csv', encoding='utf-8-sig', index=False)
            ...
            df_summary.to_csv('./data/evaluation_summary.csv', encoding='utf-8-sig', index=False)
            print("评估汇总已保存到 evaluation_summary.csv")
